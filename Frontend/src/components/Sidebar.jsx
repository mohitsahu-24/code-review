...
import { Sparkles, Plus, History, Trash2, User, LogIn, LogOut } from "lucide-react";
...
export default function Sidebar({
  ...
  return (
    <aside className="w-[290px] bg-[#0c101d] border-r border-slate-900 flex flex-col flex-shrink-0 h-full select-none">
      
      {/* Brand Logo Header */}
      <div className="flex items-center gap-3 p-5 border-b border-slate-900/60">
